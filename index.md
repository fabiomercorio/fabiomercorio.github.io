...
- <span style="color:MediumSeaGreen">``Publication``</span> <span style="color:MediumSeaGreen">``Tool``</span> New paper "FFTree: A Flexible Tree to Handle Multiple Fairness Criteria" accetped for publicat on IPM journal, special issue on XAI
