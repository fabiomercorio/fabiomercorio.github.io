...
@article{Skillink,
  author       = {Alessia De Santo and Navid Nobani and Lorenzo Malandri and Fabio Mercorio and Mario Mezzanzanica},
  title        = {Using Language Models to Extract and Map Emerging Skills to the ESCO Taxonomy},
  journal      = {Discover Artificial Intelligence},
  year         = {2026},
  issn         = {2731-0809},
  doi          = {https://doi.org/10.1007/s44163-026-01609-1},
  url          = {https://doi.org/10.1007/s44163-026-01609-1},
  keywords     = {emerging skills, ESCO taxonomy, online job ads, language models, labour market intelligence}
}

@article{VectorSimSurvey,
  author       = {Erik Cambria and Navid Nobani and Filippo Pallucchini and Fabio Mercorio},
  title        = {Benchmarking Distributional Vector Similarity Measures: A Survey},
  ...
  year         = {2026},
  issn         = {0266-4720},
  doi          = {https://doi.org/10.1111/exsy.70354},
  url          = {https://doi.org/10.1111/exsy.70354},
  keywords     = {distributional vectors, vector similarity measures, word embeddings}
}

@inproceedings{TerminatorEconomyECML,
  author       = {Fabio Mercorio and Mario Mezzanzanica and Daniele Potertì and Antonio Serino and Andrea Seveso},
  title        = {Terminator Economy: Assessing jobs and tasks exposure to AI},
  booktitle    = {Machine Learning and Knowledge Discovery in Databases- European Conference, {ECML} {PKDD} (to appear)},
...
keywords = {Synthetic data generation, Tertiary study, Survey of surveys, Machine learning, Data privacy, Evaluation metrics}
}
